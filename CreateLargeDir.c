...
#include "CreateLargeDir.h" //my file
...
int listTotal = 0;
HANDLE hdlNtCreateFile, exeHandle, ds;     // directory handle
int idata, treeLevel, trackFTA[1000][2];
int index; //variable for listbox items
			...
			switch(LOWORD(wParam))
			{
				...
				case IDC_REMOVE:
				{
					...
					if (count != LB_ERR)
					{
						...
						int err = SendMessageW(hList, LB_GETCURSEL, (WPARAM)1, (LPARAM)&index); //GETSELITEMS substituted with LB_GETCURSEL for a laugh
